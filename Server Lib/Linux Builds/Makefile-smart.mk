...
CXXFLAGS := $(CURRENT_CXXFLAGS) -fpermissive -fsigned-char -D SMARTCALCULATORLIB_EXPORTS -fPIC -std=c++20 -fvisibility=hidden

# /usr/lib/x86_64-linux-gnu/libglib-2.0.so.0.6400.6 /usr/lib/libmsodbcsql-17.so
CXXLINK := -Wl,--export-dynamic -Wl,--no-undefined -ldl -pthread -ggdb -std=c++20 -shared

# set library static owner to check modify and recompile program
#LIBSTATIC := testlib.a

# Program name
PROGRAM := SMARTCALCULATORLIB.so

# Directory Output program App
DIRSAVEPRROGRAM := ./Smart\ Calculator\ Lib

# Directory to Copy Lib
GAMESERVERDIR 		:= ./Game\ Server
MESSAGESERVERDIR 	:= ./Message\ Server

# The build folder, for all generated output. This should normally be included
# in a .gitignore rule
BUILD_FOLDER := output-smart-$(CURRENT_OBJDIR_PREFIX)

# my addiction
CFILES := \
	../Smart|Calculator|lib/Smart|Calculator|Lib/Smart|Calculator|Lib.cpp \
	../Smart|Calculator|lib/Smart|Calculator|Lib/dllmain.cpp \
	../Smart|Calculator|lib/SOCKET/pool.cpp \
	../Smart|Calculator|lib/SOCKET/socket.cpp \
	../Smart|Calculator|lib/PLAYER/player_manager.cpp \
	../Smart|Calculator|lib/TYPE/calculator_player.cpp \
	../Smart|Calculator|lib/TYPE/smart_calculator_player.cpp \
	../Smart|Calculator|lib/TYPE/stadium_calculator_player.cpp \
	../Smart|Calculator|lib/UTIL/logger.cpp \
...
$(BUILD_FOLDER)/$(PROGRAM): $(OBJ_FILES) $(LIBSTATIC)
	...
	cp $(BUILD_FOLDER)/$(PROGRAM) $(MESSAGESERVERDIR)/$(PROGRAM)
