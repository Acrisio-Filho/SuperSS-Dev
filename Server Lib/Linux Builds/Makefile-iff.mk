...
CXXLINK := -pthread -lg -ldl `pkg-config --libs libzip` `pkg-config --libs glib-2.0`
...
DIRSAVEPRROGRAM := ./IFF\ Manager

# The build folder, for all generated output. This should normally be included
# in a .gitignore rule
BUILD_FOLDER := output-iff-$(CURRENT_OBJDIR_PREFIX)

# my addiction
CFILES := \
	../IFF|Manager/IFF|Manager/IFF|Manager.cpp \
	...
	../IFF|Manager/UTIL/iff_writer.cpp
